...
Version 0.3: the sequence CRDT, the wire and snapshot formats, and awareness.
...
measured on — replays in **54.6 ms** and matches the recorded text exactly; the
same history delivered back to front, nothing applicable until the last
operation, settles in 0.30 s. See [docs/performance.md](docs/performance.md).
